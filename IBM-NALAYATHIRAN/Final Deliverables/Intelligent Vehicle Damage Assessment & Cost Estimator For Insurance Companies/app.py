...
client = Cloudant.iam("0a5eaa40-1ec2-4e70-93ef-be249fb0a282-bluemix","tYJcUyVJYs3WrpF_1absTN4RXrbdQ_RDWBRUy9BX-28c",connect=True)
database = client.create_database("image_database")



#load model
model1 = load_model('V:\\WorkSpace\\IBM-Project-7252-1658850839\\Final Deliverables\\Intelligent Vehicle Damage Assessment & Cost Estimator For Insurance Companies\\Model\\body.h5')
model2 = load_model('V:\\WorkSpace\\IBM-Project-7252-1658850839\\Final Deliverables\\Intelligent Vehicle Damage Assessment & Cost Estimator For Insurance Companies\\Model\\level.h5')
...
def upload_file():
   if request.method == 'POST':
        ...
        return render_template("prediction result.html",prediction=value)
